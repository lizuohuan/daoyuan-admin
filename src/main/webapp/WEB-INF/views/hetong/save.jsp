...
<div style="margin: 15px;">
    ...
    <form class="layui-form" action="" id="formData">
        ...
        <div class="layui-form-item ">
            ...
            <div class="layui-input-inline">
                <input type="text" name="remarks" id="remarks" placeholder="请输入备注" autocomplete="off"
        ...
        <div class="layui-form-item" id="otherAttachmentDiv">
            ...
            <div class="layui-input-inline">
                <div>
                    <%--<input type="file"  id="otherAttachment" name="file" class="layui-upload-file" lay-title="上传合同附件">--%>
...
<script>
    ...
    layui.use(['form', 'layedit', 'laydate', 'upload', 'layedit'], function () {
        ...
        form.on('submit(demo1)', function (data) {
            ...
            AM.ajaxRequestData("post", false, AM.ip + "/contract/addContract", data.field, function (result) {
