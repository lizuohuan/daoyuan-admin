    ...
    <form class="layui-form" action="" id="formData" ng-controller="editUserCtr" ng-cloak>
        ...
        <div class="layui-form-item ">
            ...
            <div class="layui-input-inline">
                <input type="text" name="bankName" value="{{bank.bankName}}" id="bankName" required lay-verify="required" placeholder="请输入" autocomplete="off"
...
<script>
    ...
    webApp.controller("editUserCtr", function($scope,$http,$timeout){
        ...
        AM.ajaxRequestData("get", false, AM.ip + "/bank/getBankById", {id : $scope.id} , function(result) {
        ...
        layui.use(['form', 'layedit', 'laydate', 'upload', 'layedit'], function() {
            ...
            form.on('submit(demo1)', function(data) {
                ...
                AM.ajaxRequestData("post", false, AM.ip + "/bank/update", data.field , function(result) {
