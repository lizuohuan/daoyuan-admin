    ...
    <form class="layui-form" action="" id="formData">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="contactsName" id="contactsName" lay-verify="required" placeholder="请输入联系人" autocomplete="off" class="layui-input" maxlength="50">
            </div>
        </div>
        ...
        <div class="layui-form-item ">
            ...
            <div class="layui-input-inline">
                <input type="text" name="phone" id="phone"  placeholder="请输入手机号" autocomplete="off" class="layui-input" maxlength="50">
            </div>
        </div>
        <div class="layui-form-item ">
            <label class="layui-form-label"><span>QQ</span></label>
            <div class="layui-input-inline">
                <input type="text" name="qq" id="qq"  placeholder="请输入QQ" autocomplete="off" class="layui-input" maxlength="50">
            </div>
        </div>
        ...
        <div class="layui-form-item ">
            ...
            <div class="layui-input-inline">
                <input type="text" name="email" id="email" lay-verify="isEmail" placeholder="请输入邮箱" autocomplete="off" class="layui-input" maxlength="50">
            </div>
        </div>
        ...
        <div class="layui-form-item ">
            ...
            <div class="layui-input-inline">
                <input type="text" name="weChat" id="weChat"  placeholder="请输入微信号" autocomplete="off" class="layui-input" maxlength="50">
            </div>
        </div>
        ...
        <div class="layui-form-item ">
            ...
            <div class="layui-input-inline">
                <input type="text" name="departmentName"   placeholder="请输入部门" autocomplete="off" class="layui-input" maxlength="50">
            </div>
        </div>
        ...
        <div class="layui-form-item ">
            ...
            <div class="layui-input-inline">
                <input type="text" name="jobTitle"   placeholder="请输入职位" autocomplete="off" class="layui-input" maxlength="50">
            </div>
        </div>
