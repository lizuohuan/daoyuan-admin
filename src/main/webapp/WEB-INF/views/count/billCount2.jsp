...
<div class="admin-main">
    ...
    <fieldset class="layui-elem-field">
        <legend>核销率&nbsp;<i class="fa fa-refresh" aria-hidden="true"></i></legend>
        <div class="layui-field-box layui-form">
...
<script>
    ...
    AM.ajaxRequestData("post", false, AM.ip + "/statistics/billIdentificationRateOfMonth",{type: 1}, function (result) {
        //寻找最大的
        var max = 0;
