...
<div class="layui-layout layui-layout-admin" style="border-bottom: solid 5px #1aa094;">
        ...
        <div class="layui-main">
            <div class="admin-login-box">
                <a class="logo" style="left: 0;" href="<%=request.getContextPath()%>/page/index">
                    <span style="font-size: 22px;">道远<span style="font-size: 10px; margin-left: 10px">v1.0</span></span></span>
                </a>
    ...
    <script>
        ...
        if (AM.getUserInfo() != null) {
            ...
            $("#userName").html(AM.getUserInfo().userName);
            $("#lockUserName").html(AM.getUserInfo().userName);
        }
        ...
        function personalInfo() {
            layer.open({
                ...
                area: ['893px', '600px'],
                anim: 1,
                content: AM.ip + "/page/user/personalDetail?id=" + AM.getUserInfo().id
            });
        }
