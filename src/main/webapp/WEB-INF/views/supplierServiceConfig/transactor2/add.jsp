    ...
    <form class="layui-form" action="" id="formData">
        ...
        <div class="layui-form-item ">
            ...
            <div class="layui-input-block">
                <div style="width: 400px;cursor: not-allowed;background: #EEEEEE" id="remindContent" class="layui-textarea">
                    <span id="cityName">XX</span>本月公积金中心变动将于<span id="day">XX</span>号<span id="dot">XX</span>点截止，请及时提交变动，避免影响<span id="operationTypeText">XX</span>账单，谢谢。
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item ">
            ...
            <div class="layui-input-inline" style="width: 150px;">
                <input type="number" name="minScope" lay-verify="required|isNumber" placeholder="缴纳比例下限" autocomplete="off" class="layui-input" maxlength="50">
            </div>
            <div class="layui-form-mid">--</div>
            <div class="layui-input-inline" style="width: 150px;">
                <input type="number" name="maxScope" lay-verify="required|isNumber" placeholder="缴纳比例上限" autocomplete="off" class="layui-input" maxlength="50">
            </div>
