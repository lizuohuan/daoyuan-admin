...
<div class="admin-main">
    ...
    <fieldset class="layui-elem-field">
        <legend>办理方列表&nbsp;<i class="fa fa-refresh" aria-hidden="true"></i></legend>
        </legend>
        <div class="layui-field-box layui-form">
            <blockquote class="layui-elem-quote">
...
<script>
    ...
    function addData() {
        var index = layer.open({
            ...
            area: ['100%', '100%'],
            content: AM.ip + "/page/supplierServiceConfig/transactor2/add?organizationId=" + AM.getUrlParam("organizationId")
        });
        layer.full(index);
    }
    ...
    function updateData(id) {
        var index = layer.open({
            ...
            maxmin: true, //开启最大化最小化按钮
            area: ['100%', '100%'],
            content: AM.ip + "/page/supplierServiceConfig/transactor2/edit?id=" + id + "&organizationId=" + AM.getUrlParam("organizationId")
        });
        layer.full(index);
    }
