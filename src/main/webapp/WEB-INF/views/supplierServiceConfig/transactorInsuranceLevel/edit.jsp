...
<div style="margin: 15px;">
    ...
    <form class="layui-form" action="" id="formData" ng-controller="controller" ng-cloak>
        ...
        <div class="layui-container" id="gradeInfo">
            <div class="layui-row">
                    ...
                    <fieldset class="layui-elem-field">
                        ...
                        <div class="layui-field-box">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" value="{{transactorInsuranceLevel.coPayPrice}}" name="coPayPrice" lay-verify="required|isDouble" placeholder="请输入比例" autocomplete="off" class="layui-input" maxlength="10">
                                </div>
                    ...
                    <fieldset class="layui-elem-field">
                        ...
                        <div class="layui-field-box">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" value="{{transactorInsuranceLevel.mePayPrice}}" name="mePayPrice" lay-verify="required|isDouble" placeholder="请输入比例" autocomplete="off" class="layui-input" maxlength="10">
                                </div>
...
<script>
    function getOnlyTransactor (payPlaceId,transactorId,insuranceLevelId, selectId) {
        AM.ajaxRequestData("POST", false, AM.ip + "/insurance/getOnlyTransactor",
                {
    ...
    webApp.controller("controller", function($scope, $timeout){
        ...
        $scope.transactorInsuranceLevel = null;
        $scope.id = AM.getUrlParam("id");
        AM.ajaxRequestData("get", false, AM.ip + "/transactorInsuranceLevel/info", {id : $scope.id} , function(result) {
            $scope.transactorInsuranceLevel = result.data;
        });
        var form = null;
        $scope.getInsuranceLevelById = function (payTheWay) {
            $("input[name=coPayType]").each(function () {
                if ($(this).val() == $scope.transactorInsuranceLevel.coPayType) {
                    $(this).click();
                }
            });
            //公司缴纳
            if ($scope.transactorInsuranceLevel.coPayType == 0) {
                ...
                $("#coUnit").html("元");
                $("input[name=coPayPrice]").val($scope.transactorInsuranceLevel.coPayPrice);
            ...
            else if ($scope.transactorInsuranceLevel.coPayType == 1) {
            ...
            //个人缴纳
            $("input[name=mePayType]").each(function () {if ($(this).val() == $scope.transactorInsuranceLevel.mePayType) {$(this).click();}});
            if ($scope.transactorInsuranceLevel.mePayType == 0) {
                ...
                $("#meUnit").html("元");
                $("input[name=mePayPrice]").val($scope.transactorInsuranceLevel.mePayPrice);
        ...
        layui.use(['form'], function() {
            form = layui.form();
            getOnlyTransactor(AM.getUrlParam("payPlaceId"),AM.getUrlParam("transactorId"), $scope.transactorInsuranceLevel.payTheWay.insuranceLevelId,$scope.transactorInsuranceLevel.payTheWayId);
            var payTheWay = JSON.parse($("select[name=payTheWayId] option:selected").attr("payTheWay"));
            $scope.getInsuranceLevelById(payTheWay);
            form.render();
            form.verify({
            ...
            form.on('submit(demo1)', function(data) {
                ...
                AM.log(data.field);
                AM.ajaxRequestData("post", false, AM.ip + "/transactorInsuranceLevel/update", data.field  , function(result) {
