...
<div style="margin: 15px;">
    ...
    <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
        <legend><span id="insuranceName"></span>--绑定档次</legend>
    </fieldset>
                ...
                <div class="layui-field-box">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="radio" name="coPayType" value="1" title="比例" lay-filter="coPayType" checked>
                    ...
                    <div class="layui-form-item ">
                        ...
                        <div class="layui-input-inline" style="width: 150px;">
                            <input type="number" name="coMinScope" lay-verify="required|isDouble" placeholder="基数下限" autocomplete="off" class="layui-input" maxlength="10">
                        </div>
                        <div class="layui-form-mid">-</div>
                        <div class="layui-input-inline" style="width: 150px;">
                            <input type="number" name="coMaxScope" lay-verify="required|isDouble" placeholder="基数上限" autocomplete="off" class="layui-input" maxlength="10">
                        </div>
                    </div>
            ...
            <fieldset class="layui-elem-field">
                ...
                <div class="layui-field-box">
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">缴纳类型<span class="font-red">*</span></label>
                        <div class="layui-input-block">
                            <input type="radio" name="mePayType" value="1" title="比例" lay-filter="mePayType" checked>
                    ...
                    <div class="layui-form-item ">
                        <label class="layui-form-label"><span>基数下上限</span><span class="font-red">*</span></label>
                        <div class="layui-input-inline" style="width: 150px;">
                            <input type="number" name="meMinScope" lay-verify="required|isDouble" placeholder="基数下限" autocomplete="off" class="layui-input" maxlength="10">
                        </div>
                        <div class="layui-form-mid">-</div>
                        <div class="layui-input-inline" style="width: 150px;">
                            <input type="number" name="meMaxScope" lay-verify="required|isDouble" placeholder="基数上限" autocomplete="off" class="layui-input" maxlength="10">
                        </div>
                    </div>
...
<script>
    ...
    function getInsuranceLevel(selectId, payPlaceId) {
        AM.ajaxRequestData("post", false, AM.ip + "/insuranceLevel/getInsuranceLevel", {
                    ...
                    insuranceId:AM.getUrlParam("insuranceId"),
    ...
    layui.use(['form', 'layedit'], function() {
        form = layui.form();
        getInsuranceLevel(0, AM.getUrlParam("payPlaceId"));

        AM.ajaxRequestData("post", false, AM.ip + "/payTheWay/getNewByInsuranceId", {
            insuranceId : AM.getUrlParam("insuranceId"),
        } , function(result){
            var insuranceLevel = result.data;
            if (insuranceLevel != null) {
                $("select[name='coComputationRule'] option").each(function () {
                    if ($(this).val() == insuranceLevel.coComputationRule) {
                ...
                $("input[name=coMaxScope]").val(insuranceLevel.coMaxScope);
                $("input[name=coMinScope]").val(insuranceLevel.coMinScope);
                $("input[name='isCMakeASupplementaryPayment']").each(function () {
                    if (Number($(this).val()) == Number(insuranceLevel.isCMakeASupplementaryPayment)) {
                        $(this).click();
                    }
                });
                $("input[name='isCDimissionSupplementaryPay']").each(function () {
                    if (Number($(this).val()) == Number(insuranceLevel.isCDimissionSupplementaryPay)) {
                        $(this).click();
                    }
                });

                $("select[name='meComputationRule'] option").each(function () {
                    if ($(this).val() == insuranceLevel.meComputationRule) {
                        $(this).attr("selected", true);
                        if ($(this).val() == 1) {
                ...
                $("input[name=meMaxScope]").val(insuranceLevel.meMaxScope);
                $("input[name=meMinScope]").val(insuranceLevel.meMinScope);
                $("input[name='isMMakeASupplementaryPayment']").each(function () {
                    if (Number($(this).val()) == Number(insuranceLevel.isMMakeASupplementaryPayment)) {
                        $(this).click();
                    }
                });
                $("input[name='isMDimissionSupplementaryPay']").each(function () {
                    if (Number($(this).val()) == Number(insuranceLevel.isMDimissionSupplementaryPay)) {
                        $(this).click();
                    }
                });
            }
        ...
        form.on('submit(demo1)', function(data) {
            ...
            data.field.insuranceId = AM.getUrlParam("insuranceId");
            AM.log(data.field);
            AM.ajaxRequestData("post", false, AM.ip + "/payTheWay/save", data.field  , function(result) {
