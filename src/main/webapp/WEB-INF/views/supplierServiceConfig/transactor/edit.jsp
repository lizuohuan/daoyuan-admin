...
<div style="margin: 15px;">
    ...
    <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
        <legend><span id="organizationName"></span>修改办理方</legend>
    </fieldset>
        ...
        <div class="layui-form-item ">
            ...
            <div class="layui-input-inline">
                <div style="width: 400px;cursor: not-allowed;background: #EEEEEE" id="remindContent" class="layui-textarea">
                    <span id="cityName"></span>本月社保变动将于<span id="day">{{transactor.remindTime}}</span>号<span id="dot">24</span>点截止，请及时提交变动，避免影响<span id="operationTypeText">XX</span>账单，谢谢。
                </div>
            </div>
        </div>
