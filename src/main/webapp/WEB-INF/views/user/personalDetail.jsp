...
<div style="margin: 15px;">
    ...
    <form class="layui-form" action="" id="formData" ng-controller="editUserCtr" ng-cloak>
            ...
            <div class="layui-form-item " >
                <label class="layui-form-label"><span >帐号</span><span class="font-red">*</span></label>
                <div class="layui-input-inline">
            ...
            <div class="layui-form-item " >
                ...
                <div class="layui-input-inline">
                    <input type="text" name="workPhone" value="{{user.workPhone}}"  lay-verify="required|isPhone" placeholder="请输入手机号" autocomplete="off" class="layui-input" maxLength="11">
                </div>
            </div>
            <div class="layui-form-item " >
