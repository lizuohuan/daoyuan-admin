        ...
        <form class="layui-form" action="" id="formData">
            <div class="layui-col-xs6" style="float: left;width: 50%">
                <fieldset class="layui-elem-field">
                    <legend>基本信息</legend>
                    <div class="layui-field-box" style="min-height: 600px;">
                        ...
                        <div class="layui-form-item ">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="userName" lay-verify="required" placeholder="请输入员工名"
                                       autocomplete="off" class="layui-input" maxlength="50">
                            </div>
                        </div>
                        <div class="layui-form-item ">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="certificateNum" lay-verify="required|isIdCard" placeholder="请输入证件编号"
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="phone" lay-verify="required|isPhone" placeholder="请输入手机号"
                        ...
                        <div class="layui-form-item hide">
                            <label class="layui-form-label">劳动合同开始日期<span class="font-red">*</span></label>
                            <div class="layui-input-inline">
                                <input type="text" id="startTime" name="contractStartTime"
                        ...
                        <div class="layui-form-item hide">
                            <label class="layui-form-label">劳动合同结束日期<span class="font-red">*</span></label>
                            <div class="layui-input-inline">
                                <input type="text" id="endTime" name="contractEndTime"
                                       onclick="layui.laydate({elem: this})"
                                       placeholder="yyyy-MM-dd" autocomplete="off" class="layui-input" maxlength="20"
                                       readonly>
                            </div>
                            ...
                            <fieldset class="layui-elem-field">
                                ...
                                <div class="layui-field-box">
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-inline">
                                            <select name="payPlaceId" id="payPlace" lay-filter="payPlaceFilter" lay-search>
                                    ...
                                    <div class="layui-form-item hide">
                                        ...
                                        <div class="layui-input-inline">
                                            <select name="transactorId" id="transactor" lay-filter="transactorFilter" lay-search>
                                                <option value=""></option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="layui-form-item hide">
                                        ...
                                        <div class="layui-input-inline">
                                            <select name="insuranceLevelId" id="insuranceLevel" lay-filter="insuranceLevel" lay-search>
                                                <option value=""></option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-form-item hide">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="number" required placeholder="基数填写" class="layui-input" name="baseNumber" readonly>
                                        </div>
                            ...
                            <fieldset class="layui-elem-field">
                                ...
                                <div class="layui-field-box">
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-inline">
                                            <select name="payPlaceGJId" id="payPlaceGJ" lay-filter="payPlaceGJFilter" lay-search>
                                                <option value=""></option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="layui-form-item hide">
                                        <label class="layui-form-label">选择经办机构<span class="font-red">*</span></label>
                                        <div class="layui-input-inline">
                                            <select name="organizationGJId" id="organizationGJ" lay-search
                                    ...
                                    <div class="layui-form-item hide">
                                        <label class="layui-form-label">选择办理方<span class="font-red">*</span></label>
                                        <div class="layui-input-inline">
                                            <select name="transactorGJId" id="transactorGJ" lay-search
                                    ...
                                    <div class="layui-form-item hide">
                                        <label class="layui-form-label">基数<span class="font-red">*</span></label>
                                        <div class="layui-input-inline">
                                            <input type="radio" value="0" disabled  name="baseNumberRadioGJ" title="最低基数" lay-filter="baseNumberRadioGJ">
                                            <input type="radio" value="1" disabled name="baseNumberRadioGJ" title="最高基数" lay-filter="baseNumberRadioGJ">
                                            <input type="radio" value="2" checked name="baseNumberRadioGJ" title="基数填写" lay-filter="baseNumberRadioGJ">
                                        </div>
                                    </div>
                                    <div class="layui-form-item hide">
                                        <label class="layui-form-label">基数填写<span class="font-red">*</span></label>
                                    ...
                                    <div class="layui-form-item ">
                                        <label class="layui-form-label">服务起始月<span class="font-red">*</span></label>
                                        <div class="layui-input-inline">
                                            <input type="text" placeholder="yyyy-MM" class="layui-input"
...
<script>
    layui.use(['form', 'layedit'], function () {
        ...
        selectProvinceAndCity(0, "cityId"); //默认调用省市
        selectProvinceAndCity(0, "cityIdGZ"); //默认调用省市
        ...
        form.on('select(companyId)', function (data) {
            ...
            getBaseCooperationMethod(0, "waysOfCooperation", data.value);
            $("#waysOfCooperation").parent().parent().show();
...
//                    $("#GZDiv").find("select[name=cityIdGZ]").attr("lay-verify", "required");
                    ...
                    $("#GZDiv").find("select[name=companySonBillIdGZ]").attr("lay-verify", "required");
                ...
                if (data.value == 3) {
                    ...
                    $("#GZDiv").find("input[name=bankAccount]").removeAttr("lay-verify");
                    $("#GZDiv").find("input[name=bankName]").removeAttr("lay-verify");
                    $("#GZDiv").find("select[name=companySonBillIdGZ]").removeAttr("lay-verify");
                } else if (data.value == 6) {
                    // 如果是商业险
                    $("#SYXDiv").hide("fast");
                } else if (data.value == 7) {
        ...
        form.on('radio(radioFilter)', function(data){
            ...
            /*$("input[name=baseNumberRadio]").parent().parent().hide("fast");
            $("input[name=baseNumber]").parent().parent().hide("fast");
        ...
        form.on('submit(demo1)', function (data) {
            ...
            AM.ajaxRequestData("post", false, AM.ip + "/member/save", data.field, function (result) {
