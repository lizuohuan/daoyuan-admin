    ...
    <fieldset class="layui-elem-field">
        ...
        <div class="layui-field-box layui-form">
            <blockquote class="layui-elem-quote">
                <button onclick="addData()" class="layui-btn layui-btn layui-btn-small layui-btn-normal  hide checkBtn_24"><i class="layui-icon">&#xe608;</i> 添加角色</button>
            </blockquote>
...
<script>
            ...
            "columnDefs": [
                ...
                },
                {
                    "render": function(data, type, row) {
                        var btn = "--";
                        if (row.id > 13) {
                            btn = "<button onclick=\"updateData(" + row.id + ", '" + row.roleName + "', '" + row.describe + "')\"  class=\"layui-btn layui-btn-small hide checkBtn_25\"><i class=\"fa fa-list fa-edit\"></i>&nbsp;修改</button>" +
                                    "<button onclick=\"deleteData(" + row.id + ")\"  class=\"layui-btn layui-btn-small layui-btn-danger hide checkBtn_26\"><i class=\"fa fa-trash-o fa-lg\"></i>&nbsp;删除</button>";
                        }
                        return btn;
    ...
    function deleteData(id) {
        var index = layer.confirm("此操作不可逆,是否确认删除？", {
            btn: ['确认', '取消'] //按钮
        }, function () {
            var arr = {
                id: id
