...
<div class="admin-main">
    ...
    <fieldset class="layui-elem-field">
        <legend>通知列表&nbsp;<i class="fa fa-refresh" aria-hidden="true"></i></legend>
        <div class="layui-field-box layui-form">
    ...
    $(document).ready(function() {
        dataTable = $('#dataTable').DataTable( {
            ...
            "ajax":  {
                ...
                "data": function(data) {
                    if ($("#begin").val() != "") {
                        data.startTimeL = AM.getTimeStamp($("#begin").val());
                    }
                    if ($("#end").val() != "") {
                        data.endTimeL = AM.getTimeStamp($("#end").val());
                    }
                }
            },
            "columns": [
