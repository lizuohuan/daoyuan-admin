...
<div style="margin: 15px;">
    ...
    <form class="layui-form" action="" id="formData">
        ...
        <div class="layui-form-item ">
            ...
            <div class="layui-input-inline">
                <input type="text" name="account" lay-verify="required" placeholder="请输入银行账号" autocomplete="off" class="layui-input" maxlength="200">
            </div>
        </div>
        ...
        <div class="layui-form-item ">
            ...
            <div class="layui-input-inline">
                <input type="text" name="bankName" lay-verify="required" placeholder="请输入开户行" autocomplete="off" class="layui-input" maxlength="200">
            </div>
        </div>
...
<script>
    layui.use(['form', 'layedit'], function() {
        ...
        form.on('submit(demo1)', function(data) {
            ...
            AM.ajaxRequestData("post", false, AM.ip + "/supplierAccountToBeCredited/save", data.field  , function(result) {
